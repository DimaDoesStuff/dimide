...
function packageTask(platform: string, arch: string, sourceFolderName: string, destinationFolderName: string, _opts?: { stats?: boolean }) {
	...
	const task = () => {
		...
		// Include node-pty from remote/node_modules (contains compiled binaries for terminal)
		const remoteDeps = gulp.src([
			'remote/node_modules/node-pty/build/Release/*.node',
			'remote/node_modules/node-pty/build/Release/*.dll',
			'remote/node_modules/node-pty/build/Release/*.exe',
			'remote/node_modules/node-pty/build/Release/conpty/*.dll',
			'remote/node_modules/node-pty/build/Release/conpty/*.exe',
			'remote/node_modules/node-pty/lib/worker/conoutSocketWorker.js',
			'remote/node_modules/node-pty/lib/shared/conout.js',
